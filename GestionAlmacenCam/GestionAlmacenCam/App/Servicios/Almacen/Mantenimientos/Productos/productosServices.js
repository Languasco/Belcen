angular.module('appGestion.productosServices', [])
    ...
    var Result = {};
        ...
        Result.get_UnidadMedidaVenta = function (idProducto) {
            let url = urlApi + 'TblCliente'
            var parameters;
            var q = $q.defer();
        ...
        Result.save_UnidadMedidaVenta = function (idProducto, idUnidadMedida, factor, idUsuario) {
                let url = urlApi + 'TblCliente'
                var parameters;
                var q = $q.defer();
                ...
                parameters = {
                    opcion: 13,
                    filtro: idProducto + '|' + idUnidadMedida + '|' + factor + '|' + idUsuario
                }
        ...
        Result.eliminar_UnidadMedidaVenta = function (id_UnidadMedida_Venta) {
            let url = urlApi + 'TblCliente'
            var parameters;
            var q = $q.defer();

            var parametros = id_UnidadMedida_Venta;
            parameters = {
                opcion: 14,
                filtro: parametros
            }
