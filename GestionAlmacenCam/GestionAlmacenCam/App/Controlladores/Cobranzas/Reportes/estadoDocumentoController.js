var app = angular.module('appGestion.estadoDocumentoController', []);
app.controller('estadoDocumentoController', function ($scope, loginServices, $location, $timeout, auxiliarServices, PagosVendedorServices, PedidosServices, CobranzaReporteServices, ArqueoCajaServices) {
    ...
    $scope.initAll = function () {
        ...
        auxiliarServices.changeTitle("Reporte Estado de Documento de Venta");
        $scope.titleModal = "Reporte Estado de Documento de Venta";
    ...
    $scope.GenerarReporte = function () {
        ...
        PagosVendedorServices.get_reporteEstadosDocumentos($scope.Objeto_ParametroFiltro)
            .then(function (data) {
                $scope.Lista_PagosVendedor = [];
